...
async function getSchedule(from, to) {
  ...
  const response = await axios.get(`${process.env.BOOKEO_API_URL}/api/schedule`, { params, headers, timeout: 15000 });
...
module.exports = { getSchedule, groupByCastMember, buildShiftDM, formatShiftLine };
