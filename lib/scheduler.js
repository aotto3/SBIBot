...
async function runCustomGameReminders(client) {
  ...
  for (const game of unfilled) {
    ...
    const content     = `<@${game.requester_id}>, @here Heads up - we are still looking for coverage for **${config.label}** for ${dateTimeStr}. Please respond if you have not yet. Thank you!`;
